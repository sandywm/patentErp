	...
	public Integer addLcMx(Integer lcId, Integer fzUserId, String lcMxName,
		...
		try {
			...
			ZlajLcMxInfoTb mxInfo = new ZlajLcMxInfoTb(fzUserId, lcDao.get(sess, lcId),
					...
					lcMxUpSize, lcMxFee, lcMxRemark,lcPjScore,-1,lastUpFileBz,lastUpFileBzSc,
					lastUpFileCus,lastUpUserIdBz,lastUpUserIdBzSc,lastUpUserIdCus,lastBzScRemark,lastCusRemark,tzsTifPath,tzsName);
