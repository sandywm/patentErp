			...
			base : '/plugins/frame/js/'
   			...
   			var page = {
   				...
   				setAgentFee : function(json){
   					...
   					strHtml += '<input type="text" id="fmDlFeeInp" placeholder="请输入发明专利代理费" value="'+ json.dlFeeFm +'" autocomplete="off" class="layui-input"/></div><div class="layui-form-mid layui-word-aux">发明代理费须为不能小于100大于99999的正整数</div></div>';
   					strHtml += '<div class="layui-form-item">';
   					strHtml += '<label class="layui-form-label">外观专利代理费</label>';
   					strHtml += '<div class="layui-input-inline posRe">';
   					strHtml += '<em class="moneyDec">¥</em>';
   					strHtml += '<input type="text" id="wgDlFeeInp" placeholder="请输入外观专利代理费" value="'+ json.dlFeeWg +'" autocomplete="off" class="layui-input"/></div><div class="layui-form-mid layui-word-aux">外观代理费须为不能小于100大于99999的正整数</div></div>';
   					strHtml += '<div class="layui-form-item">';
   					strHtml += '<label class="layui-form-label">新型专利代理费</label>';
   					strHtml += '<div class="layui-input-inline posRe">';
   					strHtml += '<em class="moneyDec">¥</em>';
   					strHtml += '<input type="text" id="xxDlFeeInp" placeholder="请输入新型专利代理费" value="'+ json.dlFeeXx +'" autocomplete="off" class="layui-input"/></div><div class="layui-form-mid layui-word-aux">新型代理费须为不能小于100大于99999的正整数</div></div>';
   					strHtml += '<div class="layui-form-item">';
   				...
   				saleBonusSet : function(json){
   					...
   					strHtml += '<input type="text" id="saleBonusInp" placeholder="请输入销售提成比例" value="'+ json.saleBonus +'" autocomplete="off" class="layui-input"/></div><div class="layui-form-mid layui-word-aux">销售提成比例数值在1-99之间设置</div></div>';
   					strHtml += '<div class="layui-form-item">';
   					strHtml += '<label class="layui-form-label"></label>';
   					strHtml += '<div class="layui-input-inline">';
